  ...
  return (
    <div className="login-page">
      <form className="login-form">
        ...
        <h3 className="login-field-header">Email</h3>
        ...
        <h3 className="login-field-header">Password</h3>

        <label className="login-password-label" htmlFor="login-pasword-label">
          <div className="password-input-wrapper">
            ...
            {passwordShown && (
              <button onClick={() => setPasswordShown(false)} 
